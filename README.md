...
## Удобство Разработки
Проект оснащен Makefile'ом и Dockerfile'ом, что позволяет легко запускать его из любой среды разработки. Дополнительные инструкции и документация доступны по ссылке: [Документация](https://karnaksp.github.io/angryverterbot/build/html/index.html).
